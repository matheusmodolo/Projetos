...
function atualizarRelogio() {
  ...
  document.getElementById("milissegundos-relogio").innerText = milissegundos;
...
function resetCronometro() {
  ...
  document.getElementById("milissegundos-cronometro").innerText = "000";
}
...
function updateCronometro() {
  ...
  document.getElementById("milissegundos-cronometro").innerText = milissegundos;
